...
const key = "6233d089612e47188ef556e509793955";
const endpoint = "https://experience.cognitiveservices.azure.com/";
...
// Parse and print all attributes of each detected face.
        detected_faces.forEach (async function (face) {
            ...
            if (emotions.length > 0) {
                console.log ("Emotions: " + emotions + face.faceAttributes.emotion);
            }
            else {
